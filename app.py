...
<div class="main-header">
    ...
    <p>Tác giả: Đinh Thanh Hải - Trường PTDTBT Tiểu học Mậu Long - ĐT: 036 4933 674</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đinh Thanh Hải - Trường PTDTBT Tiểu học Mậu Long - ĐT: 036 4933 674</div>", unsafe_allow_html=True)
